...
\begin{table} % Full width table (notice the starred environment)
	...
	\begin{tabular}{L{1\linewidth} L{1\linewidth} R{0.15\linewidth}} % Manually specify column alignments with L{}, R{} or C{} and widths as a fixed amount, usually as a proportion of \linewidth
		\toprule
		\cmidrule(r){1-2}
